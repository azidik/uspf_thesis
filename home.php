...
<body>
    ...
    <nav class="navbar fixed-top">
        <div class="container">
            <img src="public/images/seal-govph.png">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                        <img class="img-fluid rounded-circle mb-3" src="public/images/transparency_seal.jpg" alt="">
                ...
                <div class="col-lg-4">
                    <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                        <img class="img-fluid rounded-circle mb-3" src="public/images/iso.jpg" alt="">
                ...
                <div class="col-lg-4">
                    <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                        <img class="img-fluid rounded-circle mb-3" src="public/images/foi.jpg" alt="">
